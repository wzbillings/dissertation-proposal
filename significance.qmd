...
#| label: fig-dose-age
#| out-width: 6.25in
#| fig-cap: "While high dose vaccines have been shown to improve the immune
#| response in elderly individuals, there is little empirical evidence
#| showing the effect of high dose vaccines in young and middle-aged
#| vaccine recipients. While some preliminary data suggests a similar benefit
#| due to dose in younger populations, it is currently unclear how vaccine dose
#| and age interact."
