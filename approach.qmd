...
were recruited at one of two study sites in either Pittsburgh, PA or Stuart, FL.
...
received a pre-vaccination blood draw, and was then administered a split-inactivated
...
the AUC provides a framework for combining the strength and breadth measurements
into one measurement of overall response.
...
#| holdout set of the remaining 30% of data."
